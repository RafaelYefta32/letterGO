        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <h1 class="text-xl font-bold mb-4 text-gray-700 mx-auto md:mx-0">Riwayat Pengajuan Surat</h1>
                    <div
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row"
                                    ...
                                    Tugas MK
                                    iMac 27&#34;</th>
                                <td class="px-4 py-3">08-03-2025</td>
                                <td class="px-4 py-3">Disetujui</td>
                                <td class="px-4 py-3">
                                    <button type="button"
                                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Download</button>
                                    <button type="button"
