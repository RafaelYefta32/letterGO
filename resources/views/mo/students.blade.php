                        ...
                        @if ($students->isEmpty())
                            <tr>
                                <td colspan="6"
                                    ...
                                    @else
                                        Tidak ada data mahasiswa yang {{ request('status') }}.
                                    @endif
                                </td>
                            </tr>
                        @else
                                ...
                                <div id="edit{{ $student->nik }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                        ...
                                        <div
                                            ...
                                            <!-- Modal body -->
                                            <form action="{{ route('admin-user-update', [$student->nik]) }}"
                                                ...
                                                <div class="grid gap-3 mb-4 sm:grid-cols-2">
                                                    <div>
                                                        ...
                                                        <input type="text" name="nik" id="nik"
                                                            ...
                                                            maxlength="7" value="{{ $student->nik }}" readonly>
                                                    </div>
                                                    <div>
                                                        <label for="nama"
                                                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
