                        ...
                        <form action="{{ route('admin-user-store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="grid gap-3 mb-4 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-400 dark:text-gray-300" id="file_input_help">PNG,
                                        JPG, or JPEG (MAX. 2 MB).</p>
                                </div>
                            </div>
                            <button type="submit"
                                class="inline-flex items-center text-white bg-cyan-800 hover:bg-cyan-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        ...
                        @if ($users->isEmpty())
                            <tr>
                                <td colspan="6"
                                    ...
                                    @else
                                        Tidak ada data mahasiswa yang {{ request('status') }}{{ request('role') }}.
                                    @endif
                                </td>
                            </tr>
                        @else
