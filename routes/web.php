...
Route::put('/kaprodi/submissions/{pengajuan}/accept', [LetterController::class, 'accept'])->middleware(['auth', 'verified'])->name('kaprodi-submissions-accept');
Route::put('/kaprodi/submissions/{pengajuan}/reject', [LetterController::class, 'reject'])->middleware(['auth', 'verified'])->name('kaprodi-submissions-reject');
